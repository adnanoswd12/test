...
<h2><?php _e( '3. Database Import', 'wpbdp-zipcodesearch' ); ?></h2>
    ...
    <tbody>
        ...
        <tr class="actions">
            <td colspan="2">
                ...
                <a href="<?php echo esc_url( add_query_arg( 'cancel_import', 1 ) ); ?>" class="cancel-import"><?php _ex( 'Cancel Import', 'import', 'wpbdp-zipcodesearch' ); ?></a>
            </td>
        </tr>
    </tbody>
</table>
...
<h2><?php _e( '3. Database imported successfully!', 'wpbdp-zipcodesearch' ); ?></h2>
...
<div class="updated">
    ...
    <p>
        <a href="<?php echo esc_url( add_query_arg( 'nomigrate', 1) ); ?>" class="button"><?php _ex( 'Ignore the file. I want to import a new database.', 'import', 'wpbdp-zipcodesearch' ); ?></a>
        <a href="<?php echo esc_url( add_query_arg( 'migrate', 1 ) ); ?>" class="button button-primary"><?php _ex( 'Proceed with migration', 'import', 'wpbdp-zipcodesearch' ); ?></a>
    </p>
</div>
<?php endif; ?>
...
<div class="columns-wrapper">
    <div class="col-1">
        <h2><?php _e( '2. Upload database file(s)', 'wpbdp-zipcodesearch' ); ?></h2>        
    ...
    <div class="col-2">
        <?php if ( $dbfiles ): ?>
        <h2><?php _e( '... or choose a manually uploaded database file', 'wpbdp-zipcodesearch' ); ?></h2>                
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" enctype="multipart/form-data">
