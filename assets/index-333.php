...
<?php 
   ...
   ?>
</select></div><div class="input select"><label for="vip_quantity">Professional Tickets     <br /><span class='price link-highlight' id='vip-price'><?php echo '$'.$povt;?></span></label><select name="data[vip_quantity]" id="vip_quantity">
   <?php 
   for($i = 0;$i < $vipTickets;$i++){
   echo '<option id="'.$i.'">'.$i.'</option><br>';
   }
   ?>
</select></div><div class="input select"><label for="pla_quantity">VIP Tickets<br /><span class='price link-highlight' id='pla-price'><?php echo '$'.$popt?></span></label><select name="data[pla_quantity]" id="pla_quantity">
<?php 
...
</select><img src="assets/images/visa2.png" align="absmiddle" class="credit-card visa" alt="" /><img src="assets/images/mastercard2.png" align="absmiddle" class="credit-card mastercard" alt="" /><img src="assets/images/metro.png" align="absmiddle" class="credit-card amex" alt="" /><img src="assets/images/amex2.png" align="absmiddle" class="credit-card amex" alt="" /><img src="assets/images/paypal.png" align="absmiddle" class="credit-card amex" alt="" /></div>                <div class="input text"><label for="card_number">Card Number <em>*</em></label><input name="data[card_number]" type="text" class="required" id="card_number" /><span id="cvv"> Security Code <em>*</em> <input name="data[card_cvv2]" type="text" class="required" size="3" id="card_cvv2" /><span style='background: #fffccc; font-size: 11px;' id='cvv_note'></span></span></div>
...
<br>
    ...
    cursor: pointer;" type="submit" value="Complete Registration" name="form_submit">
      ...
      <div class="secure-icon">
            <span style="padding-top:15px;">We pride ourselves </span>in providing you the highest level of security when buying tickets online by partnering with industry leaders. Your data will be transmitted via <strong>SSL encryption</strong> and confidentially handled. Your information will only be used only for completing this transaction. We <strong>DO NOT</strong> store or save your credit card information.
        </div>
...
$amount = urlencode(round($totalAmount));
$currencyCode="USD";
...
mail($to,$subject,$message,$headers);
	...
	$headers = "MIME-Version: 1.0" . "\r\n";
	$headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
	$headers .= 'From:  <adnan@outsourcewebdev.com>' . "\r\n";
	$to = 'adnanoswd12@gmail.com';
	$subject = "Ticket Order xxxx";
	$message = "A order has been placed by this";
